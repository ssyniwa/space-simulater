...
def init_game():
    ...
    # 6つの惑星と5日分の全データ（選択肢 choices を追加）
    st.session_state.planet_stories = {
        "惑星ゾルバ (荒涼とした砂漠)": {
            1: {
                ...
                "choices": {
                    "A: 迅速な広域スキャンを敢行する": {"hp_bonus": 0, "morale_bonus": 5, "desc": "士気上昇"},
                    "B: 慎重に基地周辺の安全を固める": {"hp_bonus": 5, "morale_bonus": 0, "desc": "HP微増"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 嵐の中を強行偵察する": {"hp_bonus": -10, "morale_bonus": 10, "desc": "ハイリスク・ハイリターン"},
                    "B: シェルターで嵐が過ぎ去るのを待つ": {"hp_bonus": 5, "morale_bonus": -5, "desc": "安全だが士気微減"}
                },
            ...
            3: {
                ...
                "demand": {"食料": 2, "医薬品": 1, "資源": 3, "戦闘部隊": 0, "特殊アイテム": 0},
                "choices": {
                    "A: 遺跡内部へ強行突入する": {"hp_bonus": -5, "morale_bonus": 10, "desc": "積極的調査"},
                    "B: 外壁のサンプル採取にとどめる": {"hp_bonus": 5, "morale_bonus": 0, "desc": "安全策"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: カウンターハッキングで迎撃する": {"hp_bonus": 0, "morale_bonus": 5, "desc": "標準作戦"},
                    "B: 一旦距離を取って態勢を立て直す": {"hp_bonus": 10, "morale_bonus": -10, "desc": "HP回復優先"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 全速力で大気圏を突破する": {"hp_bonus": 0, "morale_bonus": 10, "desc": "迅速離脱"},
                    "B: 念のため機体チェックを入念に行う": {"hp_bonus": 5, "morale_bonus": 0, "desc": "点検優先"}
                },
        ...
        "惑星アイシリア (氷結の世界)": {
            1: {
                ...
                "choices": {
                    "A: 出力を上げて一気に拠点を設営する": {"hp_bonus": 0, "morale_bonus": 5, "desc": "迅速設営"},
                    "B: 慎重に断熱処理を行いながら進める": {"hp_bonus": 5, "morale_bonus": 0, "desc": "安全第一"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 応急処置で無理やり稼働を続ける": {"hp_bonus": -5, "morale_bonus": 5, "desc": "効率重視"},
                    "B: 機能を一部停止して温存する": {"hp_bonus": 5, "morale_bonus": -5, "desc": "温存策"}
                },
            ...
            3: {
                ...
                "choices": {
                    "A: 爆破を用いて強引に内部へ進む": {"hp_bonus": -10, "morale_bonus": 10, "desc": "強行突破"},
                    "B: バーナーでじっくりと氷を溶かす": {"hp_bonus": 5, "morale_bonus": 0, "desc": "慎重調査"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: 捜索隊を出して即座にルートを再確認": {"hp_bonus": -5, "morale_bonus": 5, "desc": "迅速対応"},
                    "B: 移動を一日見送りキャンプで休養": {"hp_bonus": 10, "morale_bonus": -5, "desc": "休養優先"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 結晶の追加採取を急ぐ": {"hp_bonus": -5, "morale_bonus": 10, "desc": "欲張り採掘"},
                    "B: 安全に離脱艇へ搭乗する": {"hp_bonus": 5, "morale_bonus": 0, "desc": "安全離脱"}
                },
        ...
        "惑星ベルデ (巨大ジャングル)": {
            1: {
                ...
                "choices": {
                    "A: 周囲の植物を焼き払って視界を確保": {"hp_bonus": 0, "morale_bonus": 5, "desc": "環境破壊"},
                    "B: 環境に配慮しつつ最低限の切り開きを行う": {"hp_bonus": 5, "morale_bonus": 0, "desc": "共生策"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 巣を特定して逆襲を仕掛ける": {"hp_bonus": -10, "morale_bonus": 15, "desc": "反撃作戦"},
                    "B: フェンスを強化して迎撃態勢をとる": {"hp_bonus": 5, "morale_bonus": -5, "desc": "防御専念"}
                },
            ...
            3: {
               "log": "ジャングルの奥地に、かつて他文明が建てたと思われる放棄された前線基地の残骸を発見しました。",
                ...
                "choices": {
                    "A: 基地のメインルームを無理やりこじ開ける": {"hp_bonus": -5, "morale_bonus": 10, "desc": "強行探索"},
                    "B: 安全な外殻部分だけを調べる": {"hp_bonus": 5, "morale_bonus": 0, "desc": "安全調査"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: 特効薬の生成を急ピッチで進める": {"hp_bonus": 0, "morale_bonus": 10, "desc": "迅速処置"},
                    "B: 気密性の高いテントでじっとやり過ごす": {"hp_bonus": 5, "morale_bonus": -5, "desc": "待機作戦"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 追加のサンプルを欲張って採取する": {"hp_bonus": -5, "morale_bonus": 10, "desc": "追加採取"},
                    "B: 速やかに離脱ポイントへ走る": {"hp_bonus": 5, "morale_bonus": 0, "desc": "迅速帰還"}
                },
        ...
        "惑星ネビュラ (ガス状浮遊大陸)": {
            1: {
                ...
                "choices": {
                    "A: 高度を上げて観測範囲を広げる": {"hp_bonus": -5, "morale_bonus": 10, "desc": "高所観測"},
                    "B: 安定した低空に基地を固定する": {"hp_bonus": 5, "morale_bonus": 0, "desc": "低空安定"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 危険な宙域で直接ワイヤーを縛り直す": {"hp_bonus": -10, "morale_bonus": 10, "desc": "命綱作業"},
                    "B: 遠隔ドローンで安全に位置を修正する": {"hp_bonus": 0, "morale_bonus": -5, "desc": "安全作業"}
                },
            ...
            3: {
                ...
                "choices": {
                    "A: オーバークロック状態で解析を急ぐ": {"hp_bonus": -5, "morale_bonus": 10, "desc": "急進解析"},
                    "B: 標準出力で慎重にデータを吸い上げる": {"hp_bonus": 5, "morale_bonus": 0, "desc": "安定解析"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: 嵐の中に出て人員を総動員して支える": {"hp_bonus": -10, "morale_bonus": 15, "desc": "総力戦"},
                    "B: 自動ロック機構に望みを託して待機": {"hp_bonus": 5, "morale_bonus": -5, "desc": "機械任せ"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 特性スラスターを全開にして急浮上する": {"hp_bonus": -5, "morale_bonus": 10, "desc": "急浮上"},
                    "B: バランスを崩さないよう慎重に離脱する": {"hp_bonus": 5, "morale_bonus": 0, "desc": "慎重離脱"}
                },
        ...
        "惑星オメガ (機械文明の廃墟)": {
            1: {
                ...
                "choices": {
                    "A: メインゲートを爆破して最短ルートで侵入": {"hp_bonus": -5, "morale_bonus": 10, "desc": "爆破侵入"},
                    "B: 地下水路伝いに隠密裏に潜入する": {"hp_bonus": 5, "morale_bonus": 0, "desc": "隠密潜入"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 正面切ってドローン部隊を撃ち払う": {"hp_bonus": -10, "morale_bonus": 15, "desc": "正面迎撃"},
                    "B: 煙幕を展開して戦闘を回避する": {"hp_bonus": 5, "morale_bonus": -5, "desc": "煙幕回避"}
                },
            ...
            3: {
                ...
                "choices": {
                    "A: 深層システムまで一気にハッキングする": {"hp_bonus": -5, "morale_bonus": 10, "desc": "深層ハック"},
                    "B: 安全なファイヤーウォール外周だけ探る": {"hp_bonus": 5, "morale_bonus": 0, "desc": "表層探索"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: バリアを拡張して敵の射撃を押し返す": {"hp_bonus": 0, "morale_bonus": 10, "desc": "バリア展開"},
                    "B: 応急パッチを当てて被害を最小限にする": {"hp_bonus": 5, "morale_bonus": 0, "desc": "応急修理"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 敵のメインコンピュータから全データを持ち出す": {"hp_bonus": -5, "morale_bonus": 15, "desc": "全データ強奪"},
                    "B: 確保した重要データだけ持ってすぐ逃げる": {"hp_bonus": 5, "morale_bonus": 0, "desc": "最小限撤収"}
                },
        ...
        "惑星ヘイロー (高放射線帯)": {
            1: {
                ...
                "choices": {
                    "A: 放射線ゾーンの深部へ一気に突き進む": {"hp_bonus": -10, "morale_bonus": 10, "desc": "深部突入"},
                    "B: 安全圏にベースキャンプを設営する": {"hp_bonus": 5, "morale_bonus": -5, "desc": "安全設営"}
                },
            ...
            2: {
                ...
                "choices": {
                    "A: 特効薬の投与量を倍にして現場に留まる": {"hp_bonus": -5, "morale_bonus": 10, "desc": "強行治療"},
                    "B: 症状の重い隊員を早期に後方送還する": {"hp_bonus": 10, "morale_bonus": -10, "desc": "後方送還"}
                },
            ...
            3: {
                ...
                "choices": {
                    "A: 放射線を浴びながら手作業で大量採取": {"hp_bonus": -15, "morale_bonus": 15, "desc": "命がけ採掘"},
                    "B: 無人アームを使って安全に採取する": {"hp_bonus": 0, "morale_bonus": 0, "desc": "安全採掘"}
                },
            ...
            4: {
                ...
                "choices": {
                    "A: 機器の出力を上げて無理やり通信を維持": {"hp_bonus": -5, "morale_bonus": 5, "desc": "通信優先"},
                    "B: 通信を一時停止して電力を節約する": {"hp_bonus": 5, "morale_bonus": -5, "desc": "電力節約"}
                },
            ...
            5: {
                ...
                "choices": {
                    "A: 最後の力を振り絞って星全体のデータを回収": {"hp_bonus": -10, "morale_bonus": 20, "desc": "完全踏破"},
                    "B: 直ちに大気圏外へ緊急脱出する": {"hp_bonus": 5, "morale_bonus": 0, "desc": "緊急脱出"}
                },
